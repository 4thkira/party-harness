...
- Brought the README up to date for everything in this release, for beginners first: a new "Letting the party live their own lives" section on downtime, the relationship web, banter, and the lorebook; Mac and Linux start steps in the very simple guide; plain explanations of the ‹ › reply arrows, the review count on the World tab, and folded earlier scenes; and new FAQ and troubleshooting entries for character cards, lore, unusable replies, and costs, including the automatic story summary. The OpenRouter steps no longer point to an address field that hosted providers do not show, and text-provider notes that sat under the image heading have moved to the text section.
...
[Unreleased]: https://github.com/4thkira/party-harness/compare/v0.7.0...HEAD
[0.7.0]: https://github.com/4thkira/party-harness/releases/tag/v0.7.0
