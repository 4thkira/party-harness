...
Manually check Help with keyboard navigation and Escape, Settings, a new session, cancellation, a paused response, world edits, memory review, draft restoration, and save/export/import. Check a narrow window as well as desktop. Fake-provider tests cannot establish real model quality, account access, image generation, or billing behavior.
